classdef ecYaliGEMAdapter < ModelAdapter
    methods
        function obj = ecYaliGEMAdapter()
            ...
            obj.params.path = fullfile('C:\Users\jujum\OneDrive\Documentos\GitHub\GECKO', 'ecYaliGEM');
			...
			% Reaction ID for glycerol exchange reaction (or other preferred carbon source)
			obj.params.c_source = 'y001808'; 
